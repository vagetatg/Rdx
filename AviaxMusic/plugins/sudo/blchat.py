...
@app.on_message(filters.command(["mblchat", "blacklistchat"]) & SUDOERS)
@language
...
@app.on_message(
    filters.command(["whitelistchat", "unblacklistchat", "munblchat"]) & SUDOERS
)
@language
...
@app.on_message(filters.command(["mblchats", "blacklistedchats"]) & ~BANNED_USERS)
@language
